...
var endGame = function() {
    ...
    //check localstorage for high score; if none stored use 0
    var highScore = localStorage.getItem("highscore");
    if (highScore === null) {
        highScore = 0;
    }
    //if player has more money than stored high score, player wins
    if (playerInfo.money > highScore) {
        ...
        alert(playerInfo.name + " did not beat the score of " + highScore + ". Maybe next time!");
    }
